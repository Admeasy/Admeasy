...
/**
 * Native Android / iOS Google Sign-In: verify ID token from @codetrix-studio/capacitor-google-auth
 * and issue the same JWT cookies as email login. Uses GOOGLE_CLIENT_ID (Web client ID) as token audience.
 */
