...
# 🚀 PROJECT CONTEXT — ADMEASY (SYSTEM OVERRIDE)

This repository belongs to **Admeasy**, a scalable MERN-based platform connecting students with mentors and colleges.

## Architecture
- Frontend: React + Tailwind
- Backend: Node.js + Express
- Database: MongoDB
- Auth: JWT (single auth system only)
- Roles: student, mentor, admin

## Core Systems
- Mentor discovery & booking
- Student dashboard
- Chat system (student ↔ mentor)
- Notes/blogs/social features
- College exploration
- Admin panel

## Engineering Rules (CRITICAL)

1. Never break authentication (JWT only)
2. Maintain production-grade scalability
3. Write modular & reusable code
4. Optimize for performance + UX
5. Detect security risks before coding
6. Always analyze full flow before editing any feature
7. Avoid patchwork fixes — prefer system-level improvements
8. Ensure mobile responsiveness
9. Keep API & frontend in sync
10. Think like senior architect, not junior coder

## AI Behavior Override

When working on this repository:
- Think like CTO of Admeasy
- Suggest better architecture when possible
- Detect performance bottlenecks
- Detect bad UX flows
- Prevent technical debt
- Prefer clean scalable solutions over quick fixes
