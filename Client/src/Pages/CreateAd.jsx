...
const CreateAd = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        toast.success('Ad request submitted! It will go live once approved.');
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <SEO title="Create Ad | Advertiser Dashboard" description="Create a new advertisement" />
      <style>{`
      ...
      <AnimatePresence mode="wait">
        {!showPreview ? (
          ...
          >
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Create New Ad</h1>
