  ...
  useEffect(() => {
    if (location.hash) {
      ...
      setTimeout(() => {
        ...
        if (element) {
          element.scrollIntoView({ behavior: "smooth" }); // Optional: smooth scroll
        }
      }, 0);
    }
  }, [location]);
      ...
      <section className="bg-white  p-8 rounded-2xl shadow-3d max-w-4xl mx-auto my-12 text-gray-800">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-10 space-y-2">
            ...
            <li>Technical data (IP address, browser type) for analytics and security purposes</li>
          </ul>
        </section>
        ...
        {/* 7. Your Rights */}
        <section className="mb-8">
          <h3 className="text-2xl font-admeasy-extrabold mb-3">7. Your Rights</h3>
          <ul className="list-disc pl-10 space-y-2">
            <li>
