...
const Contact = () => {
  ...
  return (
    <>
      ...
      */}
      <div className="lg:ml-72 ml-0 min-h-screen flex items-center justify-center p-4 transition-all duration-300">
        <motion.section
          ...
          className="p-5 bg-primary flex flex-col gap-6 rounded-3xl shadow-3d max-w-3xl w-full mx-auto"
        >
          {/* Heading */}
