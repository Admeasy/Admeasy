        ...
        <div className="w-full max-w-3xl px-2 sm:px-4 md:px-6 py-0 sm:py-2 md:py-12">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-6 border-b border-gray-100 flex-wrap">
              <Link to={`/${post.mentor?.username || post.author?.username}`} className="relative flex-shrink-0">
                <img
                  src={(post.mentor || post.author)?.image || fallbackProfilePic}
                  alt={(post.mentor || post.author)?.name || 'User'}
                  className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl object-cover ring-2 ring-gray-100 shadow-md"
                  onError={(e) => {
              ...
              <div className="flex-1 min-w-0">
                ...
                {post.mentor?.tagline && (
                  <p className="text-xs sm:text-sm text-gray-600 mt-0.5 sm:mt-1 line-clamp-1">{post.mentor.tagline}</p>
                )}
              </div>
            ...
            <div className="flex items-center gap-4 sm:gap-6 md:gap-8 px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 border-t border-gray-100">
              <motion.button
                ...
                onClick={handleLike}
                disabled={isLiking}
                className={`flex items-center gap-1.5 sm:gap-2.5 transition-colors disabled:opacity-50 ${isLiked ? 'text-red-500' : 'text-gray-600 hover:text-red-500'
                  }`}
              >
                <Heart className={`w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 ${isLiked ? 'fill-current' : ''}`} />
                <span className="text-sm sm:text-base md:text-lg font-bold">{likesCount}</span>
              </motion.button>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2.5 text-gray-600">
                ...
                <span className="text-sm sm:text-base md:text-lg font-bold">{post.commentsCount}</span>
              </div>
            ...
            <div className="border-t border-gray-100 px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 bg-gray-50/50">
                      ...
                      {viewer && comment.user?._id === viewer._id ? (
                        ...
                        >
                          <img
                            ...
                            className="w-7 h-7 sm:w-9 sm:h-9 rounded-full object-cover ring-2 ring-gray-100 hover:ring-[#9f3562]/30 transition-all cursor-pointer"
                            onError={(e) => {
                              e.target.src = fallbackProfilePic;
                            }}
                          />
                        ...
                        <Link to={'/me'} onClick={(e) => e.stopPropagation()} className="flex-shrink-0 rounded-full">
                          <img
                            src={comment.user?.image || fallbackProfilePic}
                            alt={comment.user?.name || 'User'}
                            className="w-7 h-7 sm:w-9 sm:h-9 rounded-full object-cover flex-shrink-0 ring-2 ring-gray-100"
                            onError={(e) => {
                              e.target.src = fallbackProfilePic;
                            }}
                          />
                                ...
                                {viewer && reply.user?._id === viewer._id ? (
                                  ...
                                  >
                                    <img
                                      ...
                                      className="w-6 h-6 sm:w-8 sm:h-8 rounded-full object-cover ring-2 ring-gray-100 hover:ring-[#9f3562]/30 transition-all cursor-pointer"
                                      onError={(e) => {
                                        e.target.src = fallbackProfilePic;
                                      }}
                                    />
                                  ...
                                  <img
                                    src={reply.user?.image || fallbackProfilePic}
                                    alt={reply.user?.name || 'User'}
                                    className="w-6 h-6 sm:w-8 sm:h-8 rounded-full object-cover flex-shrink-0 ring-2 ring-gray-100"
                                    onError={(e) => {
                                      e.target.src = fallbackProfilePic;
                                    }}
                                  />
              ...
              <form onSubmit={handleCommentSubmit} className="flex gap-2 sm:gap-3">
                <img
                  ...
                  className="max-w-7 max-h-7 sm:max-w-9 sm:max-h-9 md:max-w-10 md:max-h-10 rounded-full object-cover flex-shrink-0 ring-2 ring-gray-100"
                  onError={(e) => {
                    e.target.src = fallbackProfilePic;
                  }}
                />
