  ...
  const onSubmit = async (data) => {
    ...
    if (step === 3) {
      ...
      if (educationType === "college") {
        ...
        if (!universityValue) {
          toast.error(
            "University or institute name is required for college students.",
          );
          return;
        }
      }
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        if (error.code === error.PERMISSION_DENIED) {
          ...
          toast.error(
            "Location detection failed. Please retry or enter manually.",
          );
        }
      },
    );
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-2 text-sm leading-relaxed">
              We only use your location to improve college recommendations. Your
              data is private.
            </p>
          </div>
