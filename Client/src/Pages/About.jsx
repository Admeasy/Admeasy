    ...
    <div className="w-full min-h-screen bg-white">
      ...
      <div className='w-full h-full'>
        <motion.header
          ...
          <h1 className='h-about custom-top text-[1.8rem] sm:text-[4rem] md:text-7xl xl:text-8xl m-0 p-0 tracking-wide lg:tracking-widest z-5 absolute top-24 sm:top-15 md:top-16 lg:top-10 xl:top-12 left-1/2 transform -translate-x-1/2' style={{ fontSize: fSize }}>About Us</h1>
          <img src={GroupPic} className='w-full md:w-8/10 lg:w-7/10 xl:w-6/10 m-auto relative z-10 rounded-4xl mt-16 sm:mt-0' />
          <h1 className='custom-top text-[1.8rem] sm:text-[4rem] md:text-7xl xl:text-8xl m-0 p-0 text-transparent tracking-wide lg:tracking-widest z-15 absolute top-24 sm:top-15 md:top-16 lg:top-10 xl:top-12 left-1/2 transform -translate-x-1/2' style={{ WebkitTextStroke: stroke, fontSize: fSize }}>About Us</h1>
        </motion.header>
      </div>
      {/* Main Sections */}
