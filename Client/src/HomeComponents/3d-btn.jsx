...
const CustomButton = React.forwardRef(({ children, className }, ref) => {
 const baseShadow =
...
"0 4px 8px rgba(45, 35, 66, 0.3), 0 7px 13px -3px rgba(45, 35, 66, 0.2), inset 0 -3px 0 #d6d6e7";
 ...
 type="button"
 role="button"
 className={`inline-flex items-center justify-center px-4 h-12 rounded-[13px] bg-[#fcfcfd] text-[#36395a] text-[18px] font-normal cursor-pointer select-none whitespace-nowrap transition-transform duration-150 outline-none ${className ||""}`}
 style={{
