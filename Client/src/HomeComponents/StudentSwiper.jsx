...
export default function StudentSwiper() {
  ...
  return (
    <motion.section
      ...
      className="my-5 relative bg-primary p-6 rounded-2xl shadow-3d w-[90%] mx-auto">
          ...
          return (
            <SwiperSlide key={index}>
              <a
                ...
                className="mt-4 relative flex flex-col items-evenly bg-white rounded-xl shadow-md p-4 group hover:shadow-xl transition duration-300 ease-in-out">
                <div className="">
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <p className="text-sm font-medium text-[#39365c] mt-1">{student.collegeName}</p>
                    {/* Course Badge */}
