...
const FrontHome = () => {
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center bg-primary w-full shadow-3d rounded-xl overflow-hidden ">
        {/* Text Section */}
        <div className="w-full md:w-1/2 flex flex-col text-center justify-center gap-4 sm:gap-6 xl:gap-8 p-6">
        ...
        {/* Girl Image Section */}
        <div className="md:pt-13 w-full md:w-1/2 h-full relative flex justify-center md:mt-10">
          <img
            src={UpGirl}
