      ...
      >
        ...
        {loggedInAccount ? (
          <div className="relative mt-auto pt-6 border-t border-gray-100 px-3 mb-4" ref={popupRef}>
            ...
            {/* Profile Completion Circle - Only show when expanded */}
            {!isCollapsed && <ProfileCompletionCircle />}
          </div>
        ) : (
          /* Not Logged In */
          <div className="flex flex-col items-center px-3 pb-6">
            <motion.button
              ...
              className={`w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-gradient-to-r from-[#9f3562] to-[#b14270] text-white font-bold text-sm shadow-md shadow-[#9f3562]/20 hover:shadow-lg hover:shadow-[#9f3562]/30 transition-all duration-300 ${
