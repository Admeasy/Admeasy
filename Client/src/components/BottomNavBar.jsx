...
'chat with mentors'
 ...
 return (
 <div
 className={`md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 pb-safe pt-2 px-4 sm:px-6 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-50 h-16 flex items-center justify-between transition-all duration-300 ${
...
`}
 ...
 className={`${isActive ?'w-6 h-6':'w-5.5 h-5.5'} rounded-full object-cover transition-all`}
