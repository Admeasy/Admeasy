  ...
  return (
    <div className="w-full flex justify-center items-center px-2 py-16">
      <TabGroup className='w-full'>
        <TabList className="flex justify-around w-full space-x-1 rounded-xl bg-blue-900/20 p-1">
        ...
        <TabPanels className="mt-2">
          ...
          <TabPanel>
            {/* Reviews */}
            <div className="flex flex-col mx-auto mt-10 w-[90%] bg-primary rounded-2xl shadow-3d p-6 space-y-6">
              {/* Title Section */}
              <h2 className="font-admeasy-extrabold text-center text-2xl sm:text-3xl text-thead1">
                Campus Video Review
              </h2>
            ...
            <div className="bg-bg py-10 px-4 flex justify-center">
              <div className="bg-white rounded-2xl p-6 w-[90%] shadow-3d">
                {/* Title */}
                <h2 className="text-center text-xl sm:text-2xl font-bold text-thead2 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start bg-[#EDF1F8] p-4 rounded-2xl shadow-inner">
                  ...
                  <div className="text-gray-800 text-sm space-y-1 w-full">
                    <p className="text-thead2 font-semibold text-base">
                      Ravi Kumar
                    </p>
