  ...
  return (
    <StyledWrapper>
      <div className="btn-conteiner">
        <a className="btn-content" href="/colleges">
          <span className="btn-title text-[18px]">{text}</span>
          <span className="icon-arrow">
            <svg width="33pxpx" height="21px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
